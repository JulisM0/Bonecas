...
--
-- Host: localhost    Database: bonecas
-- ------------------------------------------------------
...
CREATE TABLE `carrinho` (
  ...
  UNIQUE KEY `idcarrinho_UNIQUE` (`idcarrinho`),
  KEY `fk_carrinho_usuario1_idx` (`usuario_idusuario`),
  KEY `fk_carrinho_endereço1_idx` (`endereço_idendereço`),
  KEY `fk_carrinho_produto1_idx` (`produto_idproduto`),
  CONSTRAINT `fk_carrinho_endereço1` FOREIGN KEY (`endereço_idendereço`) REFERENCES `endereço` (`idendereço`),
...
-- Dump completed on 2025-10-29 23:04:12
